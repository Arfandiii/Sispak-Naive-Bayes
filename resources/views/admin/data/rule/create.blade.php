...
<div class="content ml-12 transform ease-in-out duration-500 pt-20 px-2 md:px-5 pb-4">
    ...
    <div class="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg my-10">
        <h2 class="text-2xl font-bold mb-6">Tambah Aturan Baru</h2>
        <form action="{{ route('admin.rule.store') }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="kode_rule" id="kode_rule"
                    ...
                    placeholder="Contoh: R01" value="{{ old('kode_rule') }}">
                @error('kode_rule')
            ...
            <div class="mb-5">
                ...
                <select name="career_statement_id" id="career_statement_id" required
                    ...
                    <option value="{{ $statement->id }}" {{ old('career_statement_id')==$statement->id ? 'selected' : ''
                        }}>
