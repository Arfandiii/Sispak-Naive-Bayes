            ...
            <table class="min-w-full bg-white">
                <thead class="text-gray-700">
                    <tr class="border-b">
                        ...
                        <th class="text-left py-4 font-semibold text-gray-600">NISN</th>
                        <th class="text-left py-4 font-semibold text-gray-600">Email</th>
                        <th class="text-left py-4 font-semibold text-gray-600">Tanggal Lahir</th>
