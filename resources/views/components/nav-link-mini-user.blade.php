<div
    class="hover:cursor-pointer hover:outline hover:ml-4 justify-end pr-5 text-white hover:text-blue-200 w-full bg-blue-800 p-3 rounded-full transform ease-in-out duration-300 flex">
    @switch($iconType)
    @case('dashboard')
